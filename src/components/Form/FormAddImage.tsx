...
export function FormAddImage({ closeModal }: FormAddImageProps): JSX.Element {
  ...
  const formValidations = {
    image: {
      ...
      validate: {
        lessThan10MB: images =>
          images[0]?.size < 10000000 || 'O arquivo deve ser menor que 10MB',
        acceptedFormats: images =>
          ['image/jpeg', 'image/png', 'image/gif'].includes(images[0]?.type) ||
    ...
    description: {
      ...
      maxLength: desc => desc.length <= 65 || 'Máximo de 65 caracteres.',
    },
  };
